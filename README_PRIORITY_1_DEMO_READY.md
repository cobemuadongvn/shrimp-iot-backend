...
docs/PERMISSION_MATRIX.md
docs/DEMO_DATA.md
docs/DEMO_SCRIPT_10_PHUT.md
docs/SCREENSHOT_AND_VIDEO_LIST.md
docs/FRONTEND_HANDOFF.md
docs/REPORT_FUNCTION_EVALUATION_SECTION.md
postman/Shrimp-IoT-Priority-1.postman_collection.json
postman/Shrimp-IoT-Local.postman_environment.json
curl/E2E_TEST_CURL_WINDOWS.md
```
